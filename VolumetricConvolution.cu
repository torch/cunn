...
static int cunn_VolumetricConvolution_updateOutput(lua_State *L) {
  ...
  // Resize output
  THCudaTensor_resize5d(output, batchSize, nOutputPlane, outputDepth,
                        outputHeight, outputWidth);

  // Resize temporary columns
  THCudaTensor_resize2d(columns, nInputPlane*kD*kW*kH, outputDepth*outputHeight*outputWidth);
  ...
  if (ones->nDimension != 3 || ones->size[0]*ones->size[1]*ones->size[2] < outputDepth*outputHeight*outputWidth) {
    ...
    THCudaTensor_resize3d(ones, outputDepth, outputHeight, outputWidth);
...
static int cunn_VolumetricConvolution_updateGradInput(lua_State *L) {
  ...
  // Resize temporary columns
  THCudaTensor_resize2d(gradColumns, nInputPlane*kW*kH*kD, outputDepth*outputHeight*outputWidth);
...
static int cunn_VolumetricConvolution_accGradParameters(lua_State *L) {
  ...
  // Resize temporary columns
  THCudaTensor_resize2d(columns, nInputPlane*kW*kH*kD, outputDepth*outputHeight*outputWidth);
