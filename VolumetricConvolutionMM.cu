...
static int cunn_VolumetricConvolutionMM_updateOutput(lua_State *L) {
...
static int cunn_VolumetricConvolutionMM_updateGradInput(lua_State *L) {
  THCState *state = getCutorchState(L);
...
static int cunn_VolumetricConvolutionMM_accGradParameters(lua_State *L) {
  THCState *state = getCutorchState(L);
...
static const struct luaL_Reg cunn_VolumetricConvolutionMM__ [] = {
  {"VolumetricConvolutionMM_updateOutput", cunn_VolumetricConvolutionMM_updateOutput},
  {"VolumetricConvolutionMM_updateGradInput", cunn_VolumetricConvolutionMM_updateGradInput},
  {"VolumetricConvolutionMM_accGradParameters", cunn_VolumetricConvolutionMM_accGradParameters},
  {NULL, NULL}
};
...
void cunn_VolumetricConvolutionMM_init(lua_State *L)
{
  ...
  luaT_registeratname(L, cunn_VolumetricConvolutionMM__, "nn");
  lua_pop(L,1);
}
